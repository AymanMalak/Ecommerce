...
var correctans = [
    ...
    [
        "won't learn to play a musical instrument.",
        "won't learn to play a musical instrument.",
        "won't learn to play a musical instrument.",
        "won't learn to play a musical instrument",
        "won't learn a musical instrument.",
        "won't learn a musical instrument.",
        "won't learn a musical instrument.",
        "won't learn a musical instrument",
        2,
    ...
    [
        "will learn to play a musical instrument.",
        "will learn to play a musical instrument.",
        "will learn to play a musical instrument.",
        "will learn to play a musical instrument",
        "will learn a musical instrument.",
        "will learn a musical instrument.",
        "will learn a musical instrument.",
        "will learn a musical instrument",
        0,
    ...
    // ],
    // [
    //     "Golf is as difficult as football",
    //     "Golf is as difficult as football.",
    //     "Golf is as difficult as football.",
    //     "Golf is as difficult as football.",
    //     "golf is as difficult as football.",
...
function check() {
    ...
    do {
        ...
        correctanswer7 = correctans[counter][6]
        correctanswer8 = correctans[counter][7]
        ...
        correctans7 = correctanswer7;
        correctans8 = correctanswer8;
        ...
        if (
            ...
            userans.localeCompare(correctans7) == 0 ||
            userans.localeCompare(correctans8) == 0
        ) {
            for (let i = 0; i < 8; i++) {
                if (
                    userans
                    .toLowerCase()
                    .localeCompare(correctans[counter][i].toLowerCase()) == 0
                ) {
                    if (i >= 4) {
                        $("div.active").find(".input")[counter].value = correctans[counter][4]
                    } else {
