...
var audioTime = [[0.1, 15.3], [0.1, 15.3], [0.1, 15.3]];
var slider = document.getElementById("myRange");
var lastAudio = 0;
var ansArr1 = ["0", "0", "0", "0", "0"];
var ansArr2 = [" ", " ", " ", " ", " "];
var ansArr3 = ["0", "0", "0", "0", "0"];
var correctans = [["Golf is not as exciting as football.", "Golf isn't as exciting as football.", "Golf isn't as exciting as football", "golf is not as exciting as football", "golf i not as exciting as football.", "Golf isn't as exciting as football.", 0], ["Football is not as boring as golf.", "Football isn't as boring as golf.", "football isn't as boring as golf.", "football isn't as boring as golf", "Football isn't as boring as golf.", "Football is not as boring as golf", 2], ["Golf is not as fast as football.", "Golf isn't as fast as football.", "Golf isn't as fast as football", "Golf is not as fast as football", "Golf isn't as fast as football.", "Golf isn't as fast as football.", 1], ["Football is not as expensive as golf.", "Football isn't as expensive as golf.", "football isn't as expensive as golf.", "football isn't as expensive as golf", "Football is not as expensive as golf", "Football isn't as expensive as golf.", 1], ["Football is not as slow as golf.", "Football isn't as slow as golf.", "Football isn't as slow as golf", "football isn't as slow as golf.", "football isn't as slow as golf", "Football is not as slow as golf", 0], ["Golf is as tiring as football", "Golf is as tiring as football.", "golf is as tiring as football.", "golf is as tiring as football", "Golf is as tiring as football.", "Golf is as tiring as football.", 0], ["Golf is as difficult as football", "Golf is as difficult as football.", "golf is as difficult as football.", "golf is as difficult as football", "Golf is as difficult as football.", "Golf is as difficult as football.", 0]];
...
function fnTemplate2_v1(_div) {
  ...
  setAudio($(slide).attr("data-audioSrc")); // $(".showAnsBtn").addClass("disabled");
...
function check() {
  ...
  do {
    ...
    correctans1 = correctanswer1;
    correctans2 = correctanswer2;
    correctans3 = correctanswer3;
    correctans4 = correctanswer4;
    correctans5 = correctanswer5;
    correctans6 = correctanswer6;
    ansArr2[counter] = userans;

    if (userans.localeCompare(correctans1) == 0 || userans.localeCompare(correctans2) == 0 || userans.localeCompare(correctans3) == 0 || userans.localeCompare(correctans4) == 0 || userans.localeCompare(correctans5) == 0 || userans.localeCompare(correctans6) == 0) {
      if (userans.localeCompare(correctans[counter][0].toLowerCase()) == 0) {
        $("div.active").find(".input")[counter].value = correctans[counter][0];
      } else if (userans.localeCompare(correctans[counter][1].toLowerCase()) == 0) {
  ...
  for (var i = 0; i < ansArr2.length; i++) {
    if (ansArr2[i] != " " && ansArr2[i] == ansArr2[i + 1] && correctans[i][2] == correctans[i + 1][2]) {
...
function fnReloadAll() {
  ...
  ansArr3 = ["0", "0", "0", "0", "0"];
  $(".checkAnsBtn").addClass("disabled");
  $(".showAnsBtn").removeClass("disabled"); // $(".showAnsBtn").addClass("disabled");

  $(".input").css("color", "black");
  $(".input").css("z-index", "0");
  $("textarea").prop("disabled", false);
  $("#submit").prop("disabled", false); // $(".showAnsBtn").addClass("disabled");
...
function fnTitleAudioClick(obj) {
  ...
  $("#pButton .playImg").show();
  $("#pButton .pauseImg").hide();
  var titleAudioPath = $(obj).attr("data-audioSrc"); //console.log("fnTitleAudioClick 	" +titleAudioPath	);
...
function inputsval() {
  $(".input").on("keyup", function () {
    ...
    disableflag >= $(".input").length ? $(".checkAnsBtn").addClass("disabled") : $(".checkAnsBtn").removeClass("disabled");
  });
} // function disableShowAns (){
//   if(currentIndex==1){
//     if($('div.active  .input').length==$('div.active  .disabled2').length){
//       $(".showAnsBtn").addClass("disabled")
//     }
//   }else{
//     if($('div.active  .input').length==$('div.active  .disabled2').length){
