                        ...
                        @forelse ($products as $p)
                            <tr>
                                ...
                                @if (LaravelLocalization::getCurrentLocale() == 'ar')
                                    <td class="font-weight-bold text-primary"><a href="{{url('product',$p->id)}}">{{$p->name_ar}} </a></td>
                                    <td class="font-weight-bold text-danger">{{$p->category->name_ar}}</td>
                                @else
                                    <td class="font-weight-bold text-primary"><a href="{{url('product',$p->id)}}">{{$p->name_en}} </a></td>
                                    <td class="font-weight-bold text-danger">{{$p->category->name_en}}</td>
                                @endif
                                ...
                                @endif
                                @if (LaravelLocalization::getCurrentLocale() == 'ar')
                                <td class="font-weight-bold text-muted"> <?=  Str::substr($p->description_ar,1 ,30)." ..." ?></td>
                                @else
                                <td class="font-weight-bold text-muted"> <?=  Str::substr($p->description_en,1 ,30)." ..." ?></td>
                                @endif
                                @auth
                                    <td class="row">
